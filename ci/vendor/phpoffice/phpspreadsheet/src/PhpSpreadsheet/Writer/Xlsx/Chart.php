...
class Chart extends WriterPart
{
     ...
     * @param Title $title
     */
    private function writeTitle(XMLWriter $objWriter, $title = null)
    {
        if ($title === null) {
            return;
        }
     ...
     * @param Legend $legend
     */
    private function writeLegend(XMLWriter $objWriter, $legend = null)
    {
        if ($legend === null) {
            return;
        }
     ...
     * @param Axis $yAxis
     */
    private function writePlotArea(XMLWriter $objWriter, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, $xAxisLabel = null, $yAxisLabel = null, $xAxis = null, $yAxis = null, $majorGridlines = null, $minorGridlines = null)
    {
        if ($plotArea === null) {
            return;
        }
     ...
     */
    private function writeDataLabels(XMLWriter $objWriter, $chartLayout = null)
    {
     ...
     * @param Layout $layout
     */
    private function writeLayout(XMLWriter $objWriter, $layout = null)
    {
