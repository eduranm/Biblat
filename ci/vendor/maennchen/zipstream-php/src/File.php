...
class File
{
    ...
    public function __construct($zip, $name, $opt = null)
    {
        $this->zip = $zip;
    ...
    protected function readStream(StreamInterface $stream, $options = null)
    {
        $this->deflateInit();
        $total = 0;
    ...
    protected function deflateData(StreamInterface $stream, string &$data, $options = null)
    {
