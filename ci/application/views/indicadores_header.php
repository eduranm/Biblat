	...
	<script type="text/javascript" src="<?php echo base_url();?>js/jquery.slider.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>js/jquery.serializeJSON.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>js/jquery.blockUI.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>js/anythingslider/js/jquery.anythingslider.min.js"></script>
