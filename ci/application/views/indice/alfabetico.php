<div id="content">
  <div id="encabezado">
    <div id="migas">
      <p><a href="<?=site_url('/');?>"><?php _e('Inicio');?></a> / <?php _e('Índice');?> / <?php _e('Alfabético');?> / <?=strtoupper($letra);?></p>
    </div><!--End migas-->
    <div id="share">
      <div id="share1">
    ...
    <div class="titulo_int">
      <h1><?php _printf('Revistas por orden alfabético: %s', strtoupper($letra));?></h1>
    </div><!--end titulo_int-->
    <br class="cf">
  </div><!--end encabezado-->
