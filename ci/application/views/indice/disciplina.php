<div id="content">
  <div id="encabezado">
    <div id="migas">
      <p><a href="<?=site_url('/');?>"><?php _e('Inicio');?></a> / <?php _e('Índice');?> / <?php _e('Disciplina');?> / <?=$current['disciplina'];?></p>
    </div><!--End migas-->
    <div id="share">
      <div id="share1">
    ...
    <div class="titulo_int">
      <h1><?php _printf('Revistas del área de "%s" (%d documentos)', $current['disciplina'], $current['total']);?></h1>
    </div><!--end titulo_int-->
    <br class="cf">
  </div><!--end encabezado-->
