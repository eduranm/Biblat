<div id="content">
	<div id="encabezado">
		<div id="migas">
			<p><a href="<?=site_url('/');?>"><?php _e('Inicio');?></a> / <?php _e('Bibliometría');?> / <?php _e('Metodología');?></p>
		</div><!--End migas-->
		<div id="share">
			<div id="share1">
	...
	<div id="content_txt">
		...
		<ul>
			...
			<li><a href="<?=site_url("frecuencias/revista");?>" target="_blank"><?php _e('Número de documentos publicados por institución de afiliación del autor en las revistas');?></a></li>
			<li><a href="<?=site_url("frecuencias/revista");?>" target="_blank"><?php _e('Número de artículos publicados por año');?></a></li>
		</ul>
		<div class="cien">
			<div class="titulo_int">
		...
		<ul>
			<li><b><?php _e('De autoría y colaboración entre autores');?></b> <?php _e('(4 indicadores)');?></li>
			<li><b><?php _e('De productividad de los autores');?></b> <?php _e('(2 indicadores)');?></li>
			<li><b><?php _e('De Concentración – Dispersión, Núcleo básico de revistas y densidad de la información');?></b> <?php _e('(4 indicadores)');?></li>
			<li><b><?php _e('Coautorías');?></b> <?php _e('(3 indicadores)');?></li>
		</ul>
		...
		<div id="info-indice-coautoria" class="infoBox">
			<div class="cien">
				<div class="titulo_int">
					<h1><a href="<?=site_url("indicadores/indice-coautoria");?>" target="_blank"><?php _e('Índice de Coautoría');?></a><span class="supIndice"><a class="referencia" href="#ref1"><sup>1</sup></a></span></h1>
				</div><!--end titulo_int-->
				<br class="cf">
			</div>
				
			<p><?php _e('Este indicador muestra el número promedio de autores por artículo.');?></p>
		...
		</div><!--End Índice de coautoría-->
				
		<div id="info-tasa-documentos-coautorados" class="infoBox">
			<div class="cien">
				<div class="titulo_int">
					<h1><a href="<?=site_url("indicadores/tasa-documentos-coautorados");?>" target="_blank"><?php _e('Tasa de Documentos Coautorados');?></a><span class"supIndice"><a class="referencia" href="#ref2"><sup>2</sup></a></span></h1>
				</div><!--end titulo_int-->
	       		<br class="cf">
	      	</div>
		...
		</div><!--End Tasa de documentos coautorados-->
		...
		</div><!--End Índice de colaboración-->
		...
		<div id="info-modelo-elitismo" class="infoBox">
			...
			<p><?php _e('Es uno de los indicadores más importantes para medir la productividad científica de los autores ya que identifica la elite de autores más productivos por título de revista o país de publicación de la revista.');?></p>				
		</div><!--End Modelo de elitismo-->
		...
		</div><!--End Índice de densidad de documentos-->
		...
		</div><!--End Índice de concentración-->
		...
		</div><!--End Modelo bradford por revista-->
		...
		</div><!--End Modelo bradford por institución-->
