		...
		<p>{_('Dichos criterios están condensados en la plantilla de evaluación que se expone a continuación. Para ser aprobada, la revista candidata debe sumar al menos')}<b> {_('25 puntos.')}</b> {_sprintf('El proceso de evaluación es realizado por el Comité de Selección de Revistas para las bases de datos %s, %s y Catálogo %s.','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>', '<a href="http://azteca.cichcu.unam.mx:8991/F" target="_blank"><acronym title="SERIUNAM">SERIUNAM</acronym></a>')}</p></br>

		<div class="page_title">
            <hr/>
            <h4>{_('Plantilla de evaluación del Comité de Selección de Revistas para CLASE, PERIÓDICA y Catálogo SERIUNAM')}</h4>
            <hr/>
        </div>
		...
		<p>{_('Para')}<b> {_sprintf('solicitar la inclusión de su revista en %s y %s y el Catálogo %s','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a></b>', '<a href="http://azteca.cichcu.unam.mx:8991/F" target="_blank"><acronym title="SERIUNAM">SERIUNAM</acronym></a>')}</b>, {_sprintf('se requiere enviar los tres últimos fascículos publicados por la revista, en archivos PDF sin candados de impresión, al buzón %s (con copia a %s), o bien, la dirección electrónica (URL) de la revista, acompañado de un mensaje dirigido a Antonio Sánchez Pereyra, Presidente del Comité de Selección de %s, %s y Catálogo %s, en el que se explicite la intención de que la revista sea evaluada para su indización en dichas bases de datos','<a href="mailto:biblat@dgb.unam.mx">biblat@dgb.unam.mx</a>','<a href="mailto:claseyperiodicaunam@gmail.com">claseyperiodicaunam@gmail.com</a>','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a></b>', '<a href="http://azteca.cichcu.unam.mx:8991/F" target="_blank"><acronym title="SERIUNAM">SERIUNAM</acronym></a>')}</p>
