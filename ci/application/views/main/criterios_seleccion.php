		...
		<p>{_('Para')}<b> {_sprintf('solicitar la inclusión de su revista en %s, %s y el Catálogo %s','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a></b>', '<a href="http://azteca.cichcu.unam.mx:8991/F" target="_blank"><acronym title="SERIUNAM">SERIUNAM</acronym></a>')}</b>, {_sprintf('se requiere enviar los tres últimos fascículos publicados por la revista, en archivos PDF sin candados de impresión, al buzón %s (con copia a %s), o bien, la dirección electrónica (URL) de la revista, acompañado de un mensaje dirigido a Antonio Sánchez Pereyra, Presidente del Comité de Selección de Revistas para las bases de datos %s, %s y Catálogo %s, en el que se explicite la intención de que la revista sea evaluada para su indización en dichas bases de datos','<a href="mailto:biblat@dgb.unam.mx">biblat@dgb.unam.mx</a>','<a href="mailto:claseyperiodicaunam@gmail.com">claseyperiodicaunam@gmail.com</a>','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a></b>', '<a href="http://azteca.cichcu.unam.mx:8991/F" target="_blank"><acronym title="SERIUNAM">SERIUNAM</acronym></a>')}</p>
