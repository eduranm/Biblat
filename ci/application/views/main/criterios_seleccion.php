<div class="contenido">
	...
	<div class="textoJ">
		...
		<?php _e('<b>Criterios de normalización editorial</b>');?><br></br>
		...
		<?php _e('<b>Criterios de gestión y visibilidad</b>');?><br></br>
		...
		<?php _e('<b>Criterios de contenidos con fines de indización</b>');?><br></br>
		...
		<?php _printf('Dichos criterios están condensados en la plantilla de evaluación que se expone a continuación. Para ser aprobada, la revista candidata debe sumar al menos <b>25 puntos.</b> El proceso de evaluación es realizado por el Comité de Selección de %s y %s.','<a href="http://clase.unam.mx" target="_blank">CLASE</a>','<a href="http://periodica.unam.mx" target="_blank">PERIÓDICA</a>');?><br></br><br></br>
		<p class="textoTitulo centrado"><?php _printf('<b>Plantilla de evaluación del Comité de Selección de Revistas para %s y %s','<a href="http://clase.unam.mx" target="_blank">CLASE</a>','<a href="http://periodica.unam.mx" target="_blank">PERIÓDICA</a></b>');?></p>	
		...
		<table class="resultados centrado" border=1 cellpadding='3' cellspacing='2' summary='<?php _e('Criterios mínimos / OBLIGATORIOS');?>'>
			...
			<tbody>
				<tr class="registro">
					<td>1</td>
					<td><?php _e('<b>Mención de un editor o responsable de la revista.</b> Se valora positivamente la mención de un editor, director o responsable de la revista.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>2</td>
					<td><?php _e('<b>Datos del organismo responsable y lugar de edición.</b> Se valora positivamente si la revista proporciona información suficiente para la identificación y localización del organismo editor o institución responsable, así como los datos del lugar de edición. Los datos pueden ser: nombre completo de la institución editora, dirección postal, ciudad o lugar de edición, teléfonos, correo electrónico o sitio web.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>3</td>
					<td><?php _e('<b>Existencia de tabla de contenidos o índice.</b> Se valora positivamente si la revista proporciona la tabla de contenido o sumario en la que consten, entre otros, los nombres de los autores, título del trabajo y páginas.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>4</td>
					<td><?php _e('<b>Identificación de los autores personales o institucionales en los documentos.</b> Los trabajos deben estar firmados por los autores con nombre y apellidos o declaración de autor institucional.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>5</td>
					<td><?php _e('<b>Referencias bibliográficas en los documentos.</b> Los documentos publicados deben proporcionar una lista de referencias bibliográficas, obras citadas o notas bibliográficas al pie de página. La presencia de estas referencias será valorada solamente en artículos, ensayos o reseñas y no en cartas al editor, editoriales, entrevistas, reportajes u otro tipo de documentos que no suelen citar referencias bibliográficas.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>6</td>
					<td><?php _e('<b>Membrete bibliográfico en cubiertas o páginas de presentación.</b> Estas deberán incluir al menos el título completo de la revista, así como ISSN, volumen, número, fecha y membrete bibliográfico.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>7</td>
					<td><?php _e('<b>60% de contenido indizable.</b> Al menos el 60% de los documentos publicados en un fascículo, deben ser: artículos originales, ensayos, reseñas de libro, revisiones bibliográficas, notas de más de una cuartilla, informes técnicos o cartas al editor.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>8</td>
					<td><?php _e('<b>ISSN</b> Se considerará positivamente la existencia de código ISSN');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>9</td>
					<td><?php _e('<b>Mención del objetivo de la revista.</b> En el fascículo se debe hacer mención de los objetivos que la publicación persigue. Puede valorarse también si hace explícita su especialización temática y/o la audiencia a la que va dirigida.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>10</td>
					<td><?php _e('<b>Mención de periodicidad.</b> Para su valoración la revista debe declarar su periodicidad sin ambigüedad o bien el número de ejemplares que ofrece al año. Este criterio califica solamente la mención de periodicidad, no su cumplimiento.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>11</td>
					<td><?php _e('<b>Periodicidad semestral o más frecuente.</b> Califica positivamente si la periodicidad de la revista es semestral o más frecuente, ya que se aprecia que cumpla con su misión de difundir sus contenidos en el menor tiempo posible.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>12</td>
					<td><?php _e('<b>Cumplimiento de periodicidad.</b> Se entiende que una revista cumple su periodicidad si a lo largo del año publica el número de fascículos que se corresponden con la periodicidad expresada por la revista (por ejemplo, tres fascículos al año, en el caso de las revistas cuatrimestrales). Por lo tanto, para poder calificar este criterio es indispensable que la revista explicite el número de ejemplares que ofrece al año.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>13</td>
					<td><?php _e('<b>Existencia de un consejo, comité o cuerpo editorial.</b> Deberá constar en la revista la existencia de un cuerpo editorial que apoye al editor en diversas responsabilidades inherentes a la gestión de la revista o bien a la evaluación de las contribuciones, y deberán proporcionarse los nombres de cada uno de los que forman parte de esas instancias.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>14</td>
					<td><?php _e('<b>Servicios de indización que cubren la revista.</b> Califica positivamente si la revista está incluida en algún servicio de índices y resúmenes, directorios, catálogos, hemerotecas virtuales y listas del núcleo básico de revistas nacionales, entre otros servicios de información. Este campo califica positivamente solamente si el servicio de información es mencionado por la propia revista.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>15</td>
					<td><?php _e('<b>Clasificación de los tipos de documentos publicados (Tabla de contenido)</b> La revista debe proporcionar una clasificación de los tipos de documentos que publica, ya sea en la tabla de contenidos, al inicio de cada sección o documento, o bien en las instrucciones a los autores.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>16</td>
					<td><?php _e('<b>Instrucciones a los autores.</b> Califica positivamente si aparecen las instrucciones a los autores sobre el envío de originales.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>17</td>
					<td><?php _e('<b>Membrete bibliográfico al inicio del documento.</b> Califica positivamente si el membrete bibliográfico aparece al inicio de cada artículo e identifica a la fuente. Para darlo por cumplido el membrete debe contener por lo menos: título completo o abreviado y la numeración de la revista (volumen, número, parte, mes o sus equivalentes) ');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>18</td>
					<td><?php _e('<b>Membrete bibliográfico en cada página del documento.</b> Califica positivamente si el membrete que identifica la fuente aparece en páginas pares o impares del artículo, no necesariamente en ambas.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>19</td>
					<td><?php _e('<b>Fechas de recepción y/o aceptación del documento.</b> Califica positivamente sólo si indica ambas fechas. Esta información puede ser localizada al inicio o al final de cada artículo y es sólo exigible para artículos originales.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>20</td>
					<td><?php _e('<b>Resumen del documento.</b> Califica positivamente si se incluyen resúmenes en el idioma original del trabajo.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>21</td>
					<td><?php _e('<b>Resumen del documento en dos idiomas.</b> Califica positivamente si se incluyen resúmenes en el idioma original del trabajo y en un segundo idioma.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>22</td>
					<td><?php _e('<b>Afiliación de los autores.</b> Deberá proporcionarse el nombre de la institución de trabajo del autor o autores de cada artículo.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>23</td>
					<td><?php _e('<b>Palabras clave.</b> Deben proporcionarse palabras clave, en cualquier idioma, que describan el contenido del documento. Al igual que con los resúmenes, las palabras clave se valoran solamente en artículos.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>24</td>
					<td><?php _e('<b>Palabras clave en dos idiomas.</b> Las palabras clave deben proporcionarse en dos idiomas y al igual que en el criterio referido al idioma de los resúmenes, en este caso tampoco se considera obligatorio que estén presentes en otro tipo de documentos diferentes a los artículos.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>25</td>
					<td><?php _e('<b>Mención del sistema de arbitraje por pares.</b> En la revista deberá constar que el procedimiento empleado para la selección de los artículos a publicar es el arbitraje por pares.');?></td>
					<td><?php _e('(1 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>26</td>
					<td><?php _e('<b>Sistema de arbitraje doble ciego.</b> En la revista deberá constar que el procedimiento empleado para la selección de los artículos a publicar es el arbitraje por pares especificando que sea mediante el sistema “doble ciego”.');?></td>
					<td><?php _e('(3 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>27</td>
					<td><?php _e('<b>Mención de originalidad de los documentos.</b> Califica positivamente si en la presentación de la revista o en las instrucciones a los autores se menciona explícitamente esta exigencia para los trabajos sometidos a publicación.');?></td>
					<td><?php _e('(2 pt)');?></td>
				</tr>
				<tr class="registro">
					<td>28</td>
					<td><?php _e('<b>Apertura institucional del consejo, comité o cuerpo editorial.</b> Para calificar positivamente, los cuerpos editoriales deberán contar con evaluadores externos a la entidad editora, por lo que deberá constar su afiliación institucional. Al menos el 50% de los miembros del consejo editorial deberán pertenecer a instituciones diferentes a la editora, de lo contrario no calificará positivamente.');?></td>
					<td><?php _e('(2 pt)');?></td>
				</tr>
			</tbody>
		</table><br></br>
		<?php _printf('Para <b>solicitar la inclusión de su revista en %s y %s</b>, se requiere enviar los tres últimos fascículos publicados por la revista, en archivos PDF sin candados de impresión, al buzón %s (con copia a %s), o bien, la dirección electrónica (URL) de la revista, acompañado de un mensaje dirigido a Antonio Sánchez Pereyra, Presidente del Comité de Selección de %s y %s, en el que se explicite la intención de que la revista sea evaluada para su indización en dichas bases de datos','<a href="http://clase.unam.mx" target="_blank">CLASE</a>','<a href="http://periodica.unam.mx" target="_blank">PERIÓDICA</a></b>','<a href="mailto:biblat@dgb.unam.mx">biblat@dgb.unam.mx</a>','<a href="mailto:claseyperiodicaunam@gmail.com">claseyperiodicaunam@gmail.com</a>','<a href="http://clase.unam.mx" target="_blank">CLASE</a>','<a href="http://periodica.unam.mx" target="_blank">PERIÓDICA</a></b>');?><br></br>
		<?php _printf('Por otra parte, solicitamos, en caso de así convenir al editor de la revista, proporcionarnos la autorización para albergar los archivos PDF de la revista en la colección <b>Hemeroteca Virtual Latinoamericana</b> y ofrecer acceso al texto completo de los artículos a los usuarios de %s y %s, sin mediar por ello costo alguno para ustedes como editores ni para el usuario. Por nuestra parte y habida cuenta de las cuatro décadas de trabajo que respaldan nuestro compromiso y responsabilidad con la difusión del conocimiento científico y humanístico, asumimos lo siguiente:','<a href="http://clase.unam.mx" target="_blank">CLASE</a>','<a href="http://periodica.unam.mx" target="_blank">PERIÓDICA</a>');?><br></br>
		<ol type=a>
