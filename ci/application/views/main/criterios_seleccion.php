<div id="content">
    <div id="encabezado">
		<div id="migas">
			<p><a href="<?=site_url('/');?>"><?php _e('Inicio');?></a> / <?php _e('Postular una revista');?> / <?php _e('Criterios de selección');?></p>
		</div><!--End migas-->
		<div id="share">
			<div id="share1">
    ...
    <div id="content_txt">
		...
		<ol type=a>
			...
			<li><?php _printf('Difundir de manera transparente y gratuita los trabajos y materiales que forman parte de la publicación para su consulta por parte de la comunidad científica a través de las siguientes páginas web:');?> <a href="http://clase.unam.mx" target="_blank"><acronym title="?php _e('Citas Latinoamericanas en Ciencias Sociales y Humanidades');?>">CLASE</acronym></a>, <a href="http://periodica.unam.mx" target="_blank"><acronym title="<?php _e('Índice de Revistas Latinoamericanas en Ciencias');?>">PERIÓDICA</acronym></a> y <a href="<?=base_url();?>"><acronym title="'._sprintf('Bibliografía Latinoamericana').'">Biblat</acronym></a></li>
