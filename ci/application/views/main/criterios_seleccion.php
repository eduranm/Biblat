		...
		<p>{_('Dichos criterios están condensados en la plantilla de evaluación que se expone a continuación. Para ser aprobada, la revista candidata debe sumar al menos')}<b> {_('25 puntos.')}</b> <?php _printf('El proceso de evaluación es realizado por el Comité de Selección de %s y %s.','<a href="http://clase.unam.mx" target="_blank"><acronym title="'._sprintf('Citas Latinoamericanas en Ciencias Sociales y Humanidades').'">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="'._sprintf('Índice de Revistas Latinoamericanas en Ciencias').'">PERIÓDICA</acronym></a>');?></p></br>
