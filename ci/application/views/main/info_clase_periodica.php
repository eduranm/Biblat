    ...
    <p>{_sprintf('%s y %s se encuentran disponibles para consulta en línea en las siguientes direcciones:','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>')}</p>
    ...
    <p><a href="http://clase.unam.mx" target="_blank"><img style="float: left; padding-right: 10px;" src="{base_url('img/clase.gif')}" width="83" height="55" /></a>{$unam=_('Universidad Nacional Autónoma de México') _sprintf('%s es una base de datos bibliográfica creada en 1975 en la Universidad Nacional Autónoma de México (%s). Contiene registros bibliográficos de artículos, ensayos, reseñas de libro, revisiones bibliográficas, notas breves, editoriales, biografías, entrevistas, estadísticas y otros documentos publicados en más de 1,700 revistas publicadas en América Latina y el Caribe, especializadas en ciencias sociales y humanidades.','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://unam.mx/" target="_blank"><acronym title="$unam">UNAM</acronym></a>')}</p>

    <p>{_sprintf('Las revistas incluidas en %s cumplen con criterios de selección y son analizadas por un equipo multidisciplinario que cubre los siguientes temas:','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>')}</p>
...
{/foreach}
    ...
    <p><a href="http://periodica.unam.mx" target="_blank"><img style="float: left; padding-right: 10px;" src="{base_url('img/periodica.gif')}" width="123" height="55" /></a>{_sprintf('%s es una base de datos bibliográfica creada en 1978 en la Universidad Nacional Autónoma de México (%s). Contiene registros bibliográficos de artículos originales, informes técnicos, estudios de caso, estadísticas y otros documentos publicados en cerca de 1,500 revistas de América Latina y el Caribe, especializadas en ciencia y tecnología.','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>','<a href="http://www.unam.mx" target="_blank"><acronym title="$unam">UNAM</acronym></a>')}</p>

    <p>{_sprintf('Las revistas incluidas en %s cumplen con criterios de selección y son analizadas por un equipo multidisciplinario que cubre los siguientes temas:','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>')}</p>
...
{/foreach}
		...
		<p>{_sprintf('Metodología de indización de %s y %s:','<a href="http://clase.unam.mx" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://periodica.unam.mx" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>')}</a></p>
