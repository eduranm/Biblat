    ...
    <p>{_sprintf('%s y %s se encuentran disponibles para consulta en línea en las siguientes direcciones:','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>')}</p>

    <div align="center">
      <a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank">http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01</a><br></br>
      <a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank">http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01</a><br></br>
    </div>
    ...
    <p><a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank"><img style="float: left; padding-right: 10px;" src="{base_url('img/clase.gif')}" width="83" height="55" /></a>{$unam=_('Universidad Nacional Autónoma de México') _sprintf('%s es una base de datos bibliográfica creada en 1975 en la Universidad Nacional Autónoma de México (%s). Contiene registros bibliográficos de artículos, ensayos, reseñas de libro, revisiones bibliográficas, notas breves, editoriales, biografías, entrevistas, estadísticas y otros documentos publicados en más de 1,700 revistas publicadas en América Latina y el Caribe, especializadas en ciencias sociales y humanidades.','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://unam.mx/" target="_blank"><acronym title="$unam">UNAM</acronym></a>')}</p>

    <p>{_sprintf('Las revistas incluidas en %s cumplen con criterios de selección y son analizadas por un equipo multidisciplinario que cubre los siguientes temas:','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank"><acronym title="$clase">CLASE</acronym></a>')}</p>
...
{/foreach}
    ...
    <p><a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank"><img style="float: left; padding-right: 10px;" src="{base_url('img/periodica.gif')}" width="123" height="55" /></a>{_sprintf('%s es una base de datos bibliográfica creada en 1978 en la Universidad Nacional Autónoma de México (%s). Contiene registros bibliográficos de artículos originales, informes técnicos, estudios de caso, estadísticas y otros documentos publicados en cerca de 1,500 revistas de América Latina y el Caribe, especializadas en ciencia y tecnología.','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>','<a href="http://www.unam.mx" target="_blank"><acronym title="$unam">UNAM</acronym></a>')}</p>

    <p>{_sprintf('Las revistas incluidas en %s cumplen con criterios de selección y son analizadas por un equipo multidisciplinario que cubre los siguientes temas:','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>')}</p>
...
{/foreach}
		...
		<p>{_sprintf('Metodología de indización de %s y %s:','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>')}</a></p>

		<p>{_sprintf('Para conocer la metodología que se utiliza para el análisis documental, normalización y asentamiento de la información en %s y %s, consulte el %s.','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=cla01" target="_blank"><acronym title="$clase">CLASE</acronym></a>','<a href="http://alephv23.cichcu.unam.mx:8991/F/?func=find-b-0&local_base=per01" target="_blank"><acronym title="$periodica">PERIÓDICA</acronym></a>','<a href="http://bibliotecas.unam.mx/eventos/manual/index.html#" target="_blank">Manual de Indización</a>')}<a href="{base_url('archivos/manual_indizacion.pdf')}" target="_blank"><img style="  padding-left: 5px;" src="{base_url('img/pdf.png')}" width="16" height="16" /></a></p><br>
