                            <ul class="nav navbar-nav">
                                <li><a href="javascript:;" title="Facebook"><span class="fa fa-facebook-square"></span><span class="visible-xs-inline"> Facebook</span></a></li>
                                <li><a href="javascript:;" title="Twitter"><span class="fa fa-twitter"></span><span class="visible-xs-inline"> Twitter</span></a></li>
                                ...
                                <li><a href="javascript:;" title="{_('Imprimir')}"><span class="fa fa-print"></span><span class="visible-xs-inline"> {_('Imprimir')}</span></a></li>
                                <li class="dropdown">
