...
{foreach $areas area}
		<ul class="list-group">
			<li class="list-group-item">
					...
					<a href="{base_url('archivos/conacyt/reportes/area/$area.report.2014')}"><span class="glyphicon fa fa-file-pdf-o"></span></a>
			</li>
		</ul>
		<div class="list-group">
			<div id="{$area.journals.0.areaConacytSlug}" class="panel-collapse collapse">
				<div class="list-group">
{foreach $area.journals journal}
					<a href="{base_url('archivos/conacyt/reportes/revista/$journal.report.2014')}" class="list-group-item"><span class="glyphicon fa fa-file-pdf-o"></span> {$journal.name}</a>
{/foreach}
				</div>	
			</div>
		</div>
